...
# *                                                                                                                                     *
# *   3)  MySQL Server v8.0.36 and MySQL Shell 8.0.36                                                                                   *
# *                                                                                                                                     *
# *   4)  Python v3.x                                                                                                                   *
# *                                                                                                                                     *
# *   5)  Python3-pip                                                                                                                   *
...
# 3a. MySQL Server v8.0.36 (from Ubuntu package archive) as at April-14-2024
RUN sudo apt-get -y update 
RUN sudo apt-get -y install mysql-server 

# 3b. MySQL Shell v8.0.36 (from MySQL Shell packages download link: https://dev.mysql.com/downloads/shell/) as at April-14-2024
RUN sudo wget -c  https://dev.mysql.com/get/Downloads/MySQL-Shell/mysql-shell_8.0.36-1ubuntu22.04_amd64.deb
RUN sudo chmod u+x *.*
RUN sudo dpkg -i mysql-shell_8.0.36-1ubuntu22.04_amd64.deb
RUN sudo rm -rf mysql-shell_8.0.36-1ubuntu22.04_amd64.deb
